...
for source in MainWindow SettingsWindow MeetingsWindow DockView DockController DockDragSurface NativePasteInserter ServerClient CorrectionPrompt PromptReview CaptureHome; do
